					...
					<div class="bg-white shadow-sm p-4 mb-5" style="border-top: 3px solid teal;">
						...
						<div class="table-responsive-lg">
							<table class="table table-sm">
								...
								<tbody>
									<?php
									$query = mysqli_query($conn, "SELECT transaksi.*, konsumen.nama FROM transaksi INNER JOIN konsumen ON transaksi.idKonsumen=konsumen.username WHERE status!='keranjang' ORDER BY tanggal DESC");
									if (mysqli_num_rows($query) > 0) {
										...
										while ($data = mysqli_fetch_assoc($query)) {
											...
											<td>
												<a class='tombol tombol-teal mr-3' href='detail_pembayaran.php?id=$data[kdTransaksi]'><i class='fas fa-eye'></i> Detail</a>
											</td>
											</tr>";
											$no++;
										}
