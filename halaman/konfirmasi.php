	...
	<div class="container-fluid px-0">
		...
		<div class="konten my-5">
			<div class="rounded-top bg-white shadow p-5 mx-auto" style="width: 50%; border-bottom: 5px solid teal;">
				...
				<form method="POST" action="simpankonfirmasi.php" enctype="multipart/form-data">
					<div class="row mb-6">
						<div class="col-lg-3">
						...
						<?php 
						$data_login=$_SESSION['username'];
						$query = mysqli_query($conn, "SELECT kdTransaksi FROM transaksi WHERE idKonsumen = '$data_login';") or die("<b>Error: </b>" . mysqli_error($conn));
					...
					<div class="row mb-3">
						<div class="col-lg-3">
							<label for="gambar" >Upload Bukti Pembayaran<span class="text-danger">*</span></label>
						</div>
						<div class="col-lg-9">
