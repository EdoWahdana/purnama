			...
			<div class="row">
				...
				<div class="col-lg-9 col-8">
					<div class="bg-white shadow-sm p-4 mb-5" style="border-top: 3px solid teal;">
						<h4>Produk</h4>
						<a href="tambah_produk.php" class="tombol tombol-teal my-3">Tambah Produk</a>
								...
								<tbody>
									...
									if (mysqli_num_rows($query) > 0) {
										...
										while ($data = mysqli_fetch_assoc($query)) {
											...
											<td>$data[stok]</td>
											<td>
												<a class='tombol tombol-teal mr-3' href='edit_produk.php?id=$data[idProduk]'><i class='fas fa-edit'></i> Edit</a> 
												<button class='tombol tombol-red' name='hapus[]' id='$data[idProduk]'><i class='fas fa-trash-alt'></i> Hapus</button>
											</td>
											</tr>";
											$no++;
										}
