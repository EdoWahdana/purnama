...
<html lang="en">
<head>
  <title>Tambah Produk Poin</title>
  <meta charset="utf-8">
...
<body>
	<div class="container-fluid px-0">
		...
		<div class="konten container mt-5">
			<a href="data_produk_poin.php" class="tombol tombol-teal mb-3"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
			<div class="row">
				...
				<div class="col-lg-9 col-8">
					<div class="bg-white shadow-sm p-4 mb-5" style="border-top: 3px solid teal;">
						<form enctype="multipart/form-data" id="formIsian">
									...
									<select class="form-control" id="kategori" name="kategori">
										...
										if (mysqli_num_rows($query) > 0) {
											while ($data = mysqli_fetch_assoc($query)) {
												echo "<option value='$data[idKategori]'>$data[nmKategori]</option>";
											}
										} else
							...
							<div class="row mb-3">
								<div class="col-lg-3">
									<label for="jumlahPoin" class="mt-lg-1">Jumlah Poin</label>
								</div>
								<div class="col-lg-9">
									<div class="input-group">
										<input type="text" class="form-control" id="jumlahPoin" name="jumlahPoin">
...
<script>
	...
	$("#formIsian").on("submit", function(e) {
		...
		$(".helper span").html("");
		$.ajax({
			url: "../include/inputProdukPoin.php",
			type: "POST",
			data: formData,
			contentType: false,
			cache: false,
