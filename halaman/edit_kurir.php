...
<body>
	<div class="container-fluid px-0">
		...
		<div class="konten container mt-5">
			<a href="data_kurir.php" class="tombol tombol-teal mb-3"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
			<div class="row">
				...
				<div class="col-lg-9 col-8">
					<div class="bg-white shadow-sm p-4 mb-5" style="border-top: 3px solid teal;">
						<form enctype="application/x-www-form-urlencoded" id="formIsian">
							<div class="row mb-3">
								<div class="col-lg-3">
									<label for="nama" class="mt-lg-1">Nama Kurir</label>
								</div>
								<div class="col-lg-9">
