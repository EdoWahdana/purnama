							...
							<div class="row mb-3">
								...
								<div class="col-lg-9">
									<div class="input-group">
										<input type="text" class="form-control" id="jumlahPoin" name="jumlahPoin" value="<?php echo $jumlahPoin; ?>">
...
<script>
	...
	$("#formIsian").on("submit", function(e) {
		...
		$(".helper span").html("");
		$.ajax({
			url: "../include/updateProdukPoin.php",
			type: "POST",
			data: formData,
			contentType: false,
			cache: false,
