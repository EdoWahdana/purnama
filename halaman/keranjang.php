			...
			<div class="rounded-top bg-white shadow p-5 mx-auto my-5" style="width: 75%; border-bottom: 5px solid teal;">
				...
				<div class="table-responsive-lg">
					...
					<div class="text-right mt-5">
						...
						<button type="button" class="tombol tombol-teal" id="submitBayar"><a href="DataUndangan.php">Masukan Informasi Pesanan</a></button>	
					</div>
	...
	//function updateOrder() {
		//$.ajax({
			...
			//success: function (respon) {
				...
				//if (respon.status == "Berhasil") {
					//location.href = "pembayaran.php?id=<?php echo $kdTransaksi; ?>";
				//} else {
					//$(".helper span").css("color", "red");
